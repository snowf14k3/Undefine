                    ...
                    if (mc.objectMouseOver != null && mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK ) {
                        ...
                        try {
                            if(tile != null && Class.forName("thaumcraft.common.tiles.TileNode").isInstance(tile)){
                                ...
                                ItemStack is = block.getPickBlock(mop, mc.theWorld,mop.blockX, mop.blockY, mop.blockZ);
                                for (int i = 0; i < (1 * Scan_Number.getValueState()); i++)
            ...
            if(NeiMod() && mc.currentScreen != null){
                ...
                if (screen instanceof GuiContainer) {
                    try {
                        ...
                        Method isMouseOverSlot = GuiContainer.class.getDeclaredMethod(ClientLoader.runtimeDeobfuscationEnabled ? "func_146981_a" : "isMouseOverSlot", Slot.class, Integer.TYPE, Integer.TYPE);
