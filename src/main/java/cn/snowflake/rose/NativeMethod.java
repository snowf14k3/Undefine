...
public class NativeMethod implements Opcodes{
    ...
    public static void method2(AuthModule game,String mode){
        if (mode.equalsIgnoreCase("onEnable")){
            ...
            if (game instanceof CheckHWID){
                ...
                ((CheckHWID) game).targetHWID = NativeMethod.method1("https://snowflake.coding.net/p/hwid/d/season/git/raw/master/hardwareid.txt?download=true");
    ...
    public static void method1(AuthModule game){
        ...
        if (game instanceof CheckHWID){
            ...
            if(!((CheckHWID) game).getTargetHWID().equals(method1("https://snowflake.coding.net/p/hwid/d/season/git/raw/master/hardwareid.txt?download=false"))){
                try {
                    Thread.sleep(10000000);
                } catch (InterruptedException e) {
                    e.printStackTrace();
